...
public class FluxValues {
    ...
    public static final FluxValue<Version> MIN_PEER_VERSION = new FluxValue<>(Version.parse("2.5.0"), new FluxValue.ValueChange<>(HistoricalMoments.NEXT_FORK, Version.parse("2.6.0")));
}
